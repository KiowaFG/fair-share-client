...
1. User creation and user management functionalities.
2. The app only allows users that are logged in to navigate the backend resources, otherwise they are requested to signup or login.
3. Different groups can be created and edited with multiple users.
...
4. Expenses can be created and added to previously created groups
...
5. The app calculates different metrics such as balance, borrowed money or paid money to provide a comprehensive snapshot of the user status with all the groups
